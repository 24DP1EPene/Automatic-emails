...
def string_to_date(send_date: str) -> datetime.date:
    ...
    pieņem <str> tipa vērtību <send_date>
    un atgriež <datetime.date> tipa vērtību <date>
    """
...
def string_to_time(send_time: str) -> datetime.time:
    ...
    pieņem <str> tipa vērtību <send_time>
    un atgriež <datetime.time> tipa vērtību <time>
    """
...
def combined_date_time(send_date: str, send_time: str) -> datetime:
    ...
    pieņem <str, str> tipa vērtību <send_date, send_time>
    un atgriež <datetime> tipa vērtību <date>
    """
...
def send_email_on(send_date: str, send_time: str) -> bool:
    ...
    pieņem <str, str> tipa vērtību <send_date, send_time>
    un atgriež <bool> tipa vērtību <bool>
    """
